...
## Closed — Takeover, UI-00, engine, G-05, G-06

G-00 through G-06 and UI-00 are closed on `main`. Do not re-open them without a
...
## Next executable — G-07 (waiting for explicit GO)

- [ ] Embeddings and reranking (`missions/05-embeddings-and-reranking.md`).
